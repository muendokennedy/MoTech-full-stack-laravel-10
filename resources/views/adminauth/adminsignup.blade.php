    ...
    <div class="sigup-box bg-white p-4 px-8 rounded-md w-[30rem] mx-auto">
          ...
          @csrf
            ...
            <div class="input-box">
              ...
              <input type="text" name="name" id="name" class="@error('name') border-red-600 @enderror p-2 rounded-md border-2 outline-none w-full focus:border-[#042EFF] transition-all duration-300 ease-in-out">
              @error('name')
            ...
            <div class="input-box">
              ...
              <input type="password" name="password" id="password" class="p-2 rounded-md border-2 outline-none w-full focus:border-[#042EFF] transition-all duration-300 ease-in-out">
              @error('password')
              <p class="text-red-600 text-sm sm:text-base py-2 w-full">{{$message}}</p>
              @enderror
            </div>
            <div class="input-box">
              ...
              <input type="password" name="password_confirmation" id="password_confirmation" class="p-2 rounded-md border-2 outline-none w-full focus:border-[#042EFF] transition-all duration-300 ease-in-out">
