...
<div class="payment-box h-auto w-full mx-auto border-2 p-6 rounded-xl mt-4 shadow-[5px_5px_15px_8px_rgba(56,72,87,0.2)]">
    ...
    <div class="payment-methods-container flex flex-wrap md:flex-nowrap p-4 gap-4">
        <input type="checkbox" name="mpesaPayment" id="mpesa" class="mpesa-checkbox hidden">
        <label for="mpesa" class="mpesa w-full sm:basis-1/3 h-28 cursor-pointer border-2 hover:border-green-600 rounded-md flex justify-center items-center">
